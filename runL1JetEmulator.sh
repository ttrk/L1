...
./L1JetEmulator.exe "/export/d00/scratch/luck/Hydjet1p8_2760GeV_L1UpgradeAnalyzer_GT_run1_mc_HIon_L1UpgradeAnalyzer.root" "~/scratch/Hydjet276_JetResults${TAGNAME}.root" || exit 1
./L1JetEmulator.exe "/export/d00/scratch/luck/HydjetMB_740pre8_MCHI2_74_V3_53XBS_L1UpgradeAnalyzer_GT_MCHI2_74_V3.root" "~/scratch/Hydjet502_JetResults${TAGNAME}.root" || exit 1
./L1JetEmulator.exe "/mnt/hadoop/cms/store/user/men1/L1Data/HIL1DPG/MinBias/HIMinBiasUPC_Skim_HLT_HIMinBiasHfOrBSC_v2_CaloRegionEta516_CMSSW740pre7/L1NTupleMBHI.root" "~/scratch/MBData_JetResults${TAGNAME}.root" || exit 1
...
./makeTurnOn.exe "~/scratch/Hydjet276_JetResults${TAGNAME}.root" "/mnt/hadoop/cms/store/user/ginnocen/Hydjet1p8_TuneDrum_Quenched_MinBias_2760GeV/HiMinBias_Forest_26June2014/d9ab4aca1923b3220eacf8ee0d550950/*.root" "hist_hydjet276${TAGNAME}.root" 1 || exit 1

./makeTurnOn.exe "~/scratch/Hydjet502_JetResults${TAGNAME}.root" "~/scratch/HydjetMB_740pre8_MCHI2_74_V3_53XBS_HiForest_partial.root" "hist_hydjet502${TAGNAME}.root" 1 || exit 1

./makeTurnOn.exe "~/scratch/MBData_JetResults${TAGNAME}.root" "/mnt/hadoop/cms/store/user/luck/L1Emulator/minbiasForest_merged_v2/HiForest_PbPb_Data_minbias_fromSkim_v3.root" "hist_MBData${TAGNAME}.root" 0 || exit 1
